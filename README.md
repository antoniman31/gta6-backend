...
Veille automatisée de l'actualité GTA 6 : un robot interroge 47 sources en
...
2. **Récupère les 47 sources** (liste `FEEDS`) **en parallèle**, avec
...
(instantané), l'autre fait travailler le robot sur les 47 sources
(~1 min 25).
