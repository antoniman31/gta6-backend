...
- **`docs/index.html`** — l'app elle-même : une vraie PWA installable,
  ...
  recherche, filtres, mode dense, compte à rebours jusqu'à la sortie du
  jeu (19 novembre 2026) avec 4 paliers visuels d'intensité croissante à
  mesure que la date approche : normal (>30j) → teinte orangée discrète
  (7-30j) → pulsation orange (24h-7j) → mode urgence rouge/majuscules
  (<24h).
